...
describe("stores", () => {
  ...
  it("remove stock with code input reason=reject ", () => {
    ...
    cy.get("table")
      ...
      .should(
        "contain.text",
        "code: 208M05015XL - size: 5XL - amount: 1 - reason: reject"
      );
  });

  it("transfer stock", () => {
    cy.get("#transferStockButton").should("be.visible").click();
    cy.get("#stockCodeInput").type("208M05015XL"); //purple / dark purple 5XL
    ...
    cy.get("table")
      ...
      .should(
        "contain.text",
        "edit entry - code: 208M05015XL location: cornwall amount: 1"
      );
    ...
    cy.get("table")
      ...
      .should(
        "contain.text",
        "code: 208M05015XL - size: 5XL - amount: 1 - reason: transfer from: hawkins"
      );
  });
